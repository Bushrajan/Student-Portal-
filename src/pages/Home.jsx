    ...
    return (
        <div className="max-w-7xl mx-auto">
            <motion.div
                ...
                className=" rounded-xl py-6 flex  justify-between gap-5 w-full bg-white shadow-md  mt-6"
            >
                {/* Header */}
                <div className="flex gap-3 lg:justify-between justify-center items-start  mx-auto">
                    ...
                    <div className="text-center m">
                        <h2 className="text-xl mb-1 font-bold lg:text-left text-black">{user?.name || "John Doe"}</h2>
                        <h2 className="flex lg:text-left lg:text-[15px] lg:justify-start  justify-center font-medium  gap-2 text-sm  text-[12px] mx-auto rounded-full px-1">
                            {user?.rollNo || "L1PCBCS56"}
                        </h2>
                        <p className="flex  lg:text-[15px] font-medium gap-2 text-sm  border-gray-500 text-[12px] mx-auto rounded-full px-1 mb-1 text-gray-500"> {user?.faculty || "Faculty of Information Technology and Computer Science"}
                        </p>
                        <span className="w-[150px] flex gap-2 justify-center items-center lg:mx-0 mx-auto text-sm border bg-[#ebc9a453] border-[#de8628] text-[12px] rounded-full px-1 py-1 mb-1 text-[#de8628]">
                            <LuGraduationCap color="#de8628" /> {user?.program || "BS Computer Science"}
                        </span>
                    </div>
                </div>
