                        ...
                        {menuItems.map((item, index) => {
                            ...
                            return (
                                <motion.button
                                    ...
                                    className={`w-full flex justify-between items-center gap-3 px-4 py-4 rounded-md text-left transition-all duration-300 ${isActive
                                ...
                                >
                                    <span className="flex gap-3 items-center">
                                        <span
                                            className={`text-[20px] ${isActive ? "text-[#de8628]" : "text-gray-500 hover:text-gray-600"
                                                }`}
                                        >
                                            {item.icon}
                                        </span>
                                        <span
                                            className={`text-sm font-medium ${isActive ? "text-[#de8628]" : "text-gray-500 hover:text-gray-600"
                                                }`}
                                        >
                                            {item.name}
                                        </span>
